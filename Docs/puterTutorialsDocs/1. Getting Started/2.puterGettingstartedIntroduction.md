# Puter.js: Serverless Auth, Cloud, and AI Powered by Puter.
[](#puter-js)Puter.js
---------------------
...
#### [](#write-a-file-to-the-cloud)Write a file to the cloud
...
#### [](#save-user-preference-in-the-cloud-key-value-store)Save user preference in the cloud Key-Value Store
...
#### [](#chat-with-gpt-4-1-nano)Chat with GPT-4.1 nano
